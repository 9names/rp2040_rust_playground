//! Test out gzip decoding using zune-inflate
...
fn main() -> ! {
    ...
    // test that zune_inflate can decompress text from the gzip file
    let mut d = DeflateDecoder::new(ZLIB_TEXT);
    let message = d.decode_gzip().unwrap();
