...
use rp235x_hal::{
    ...
    pio::{
        PIO, PIOExt, PinDir, PinState, ShiftDirection, StateMachine, StateMachineIndex, Tx,
...
pub struct UnicornPins {
    ...
    pub led_latch: Pin<DynPinId, FunctionPio0, PullNone>,
    pub led_clock: Pin<DynPinId, FunctionPio0, PullNone>,
    pub led_data: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_0: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_1: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_2: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_3: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_4: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_5: Pin<DynPinId, FunctionPio0, PullNone>,
    pub row_6: Pin<DynPinId, FunctionPio0, PullNone>,
}

#[allow(dead_code)]
pub struct UnicornDynPins([Pin<DynPinId, FunctionPio0, PullNone>; 11]);
    ...
    SM: ValidStateMachine<PIO = P>,
{
    ...
    pio: &'pio mut PIO<P>,
    #[allow(dead_code)]
    sm: StateMachine<SM, rp235x_hal::pio::Running>,
    tx: Tx<SM>,
    #[allow(dead_code)]
    pins: UnicornDynPins,
}
    ...
    SM: StateMachineIndex,
{
    ...
    pub fn new(
        ...
        let led_blank = pins.led_blank;
        let led_latch = pins.led_latch;
        let led_clock = pins.led_clock;
        let led_data = pins.led_data;
        let row_0 = pins.row_0;
        let row_1 = pins.row_1;
        let row_2 = pins.row_2;
        let row_3 = pins.row_3;
        let row_4 = pins.row_4;
        let row_5 = pins.row_5;
        let row_6 = pins.row_6;

        let (mut sm, _rx, tx) = rp235x_hal::pio::PIOBuilder::from_installed_program(installed)
